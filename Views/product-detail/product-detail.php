                ...
                <div class="col-xs-12">
                    <div class="pages-title-text text-center">
                        ...
                        <ul class="text-left">
                            ...
                            <li><span> // </span><a href="?act=shop">Danh mục</a></li>
                    ...
                    <div class="reviews padding60 margin-top">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="info-reviews moreinfo tab-pane fade in active" id="moreinfo">
                                <div class="tb">
                                    <h5>Thông tin chi tiết của mỹ phẩm</h5>
                                    <ul>
                                        <li>
                                            <span>Thương hiệu mỹ phẩm</span>
                                            <div><?= $data['Hang'] ?></div>
                                        </li>
                            ...
                            <div class="<?php if ($data['MaDM'] == 1) {
                                ...
                                <div class="about-author">
                                    ...
                                    <div class="post-comments">
                                        <!-- comment -->
                                        <div class="fb-comments" data-href="https://24h.com?act=detail&id=<?= $data['MaSP'] ?>" data-numposts="5" data-width=""></div>
                                        <!-- /comment -->
                                    </div>
                                    <!-- /comments -->
                                </div>
